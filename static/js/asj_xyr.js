...
//嫌疑人
	...
	$("#asjqs_page3").load("html/qsfx/xyr.html",function(){		
		function xyr(){
			$(document).ready(function(){
				...
				var policestationcj2 = $('#policestationcj3');
				var projecttotal2 = $('#projecttotal3');//console.log(projecttotal3);
				...
				//var dateString = "2018-01-04";
				var dateStringify = year +month + ri;
				//var dateStringify = "20180104";
				
				//input框初始化
				$("#datejq3").val(dateString);
				var selectdate = dateString;
				var startyear = "18";
				
				//统计项目
				var projecttotal2 = $('#projecttotal3');
				var tenyearsdata = [];
				
				var initdata = {

						    	date:dateStringify,
						    	field:projecttotal2.val(),
						    	caseDutyArea:jxqy2.val(),
				...
				$("#calc3").click(function(){
					...
					calc2(datahours,datamonth,dataday,datasn);
					//更新时间
			    	$(".thisdate3").text(year + "-" + month + "-" + days);
				})
				...
				function r_qs_fun2(thisData,lastData){
					...
					var Chart = echarts.init(document.getElementById('r_qs3'));
				...
				function z_qs_fun2(){
					...
					var Chart = echarts.init(document.getElementById('z_qs3'));
					Chart.setOption(option);	
				}
				// // //z_qs_fun();
				...
				function y_qs_fun2(thisData,lastData){
					...
					var Chart = echarts.init(document.getElementById('y_qs3'));
					Chart.setOption(option);	
				}
				// // //y_qs_fun();
				...
				function n_qs_fun2(thisData,lastData){
					...
					var Chart = echarts.init(document.getElementById('n_qs3'));
					Chart.setOption(option);	
				}
				// // // //n_qs_fun();
				...
				function sn_qs_fun2(thisData,lastData,thisyear){
							...
							var Chart = echarts.init(document.getElementById('wn_qs3'));
							Chart.setOption(option);	
				}
				...
				function calc2(datahours,datamonth,dataday,datasn){
					...
					$.ajax({
						type:'GET',
						url:'api/suspectTrend/getByYear',
					...
					$.ajax({
							type:'GET',
							url:'api/suspectTrend/getByHour',
					...
					$.ajax({
							type:'GET',
							url:'api/suspectTrend/getByMonth',
							data:datamonth,
						    // data:{
						    // 	date:"20180101",
						    // 	field:"FKSL"
