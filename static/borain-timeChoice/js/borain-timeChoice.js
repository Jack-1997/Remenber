...
function borainTimeChoiceCancel(start,end){
    ...
    function TimeInitialization(format){
        ...
        if(format == "yyyyMMdd"){
            var time1 = yesterDay.getFullYear() + '-' + (yesterDay.getMonth() + 1) + '-' + yesterDay.getDate();
            var time2 = toDay.getFullYear() + '-' + (toDay.getMonth() + 1) + '-' + toDay.getDate();
            $(".start").val(time1);
            $(".end").val(time2);
        }else if(format == "yyyyMMddhh"){
            var time1 = yesterDay.getFullYear() + '-' + (yesterDay.getMonth() + 1) + '-' + yesterDay.getDate() + " 00:00";
            var time2 = toDay.getFullYear() + '-' + (toDay.getMonth() + 1) + '-' + toDay.getDate() + " " + toDay.getHours() + ":00";
            $(".start").val(time1);
            $(".end").val(time2);
        }else if(format == "yyyyMMddhhh"){
            var time1 = toDay.getFullYear() + '-' + (toDay.getMonth() + 1) + '-' + toDay.getDate() + " 00:00";
            var time2 = toDay.getFullYear() + '-' + (toDay.getMonth() + 1) + '-' + toDay.getDate() + " " + toDay.getHours() + ":00";
            $(".start").val(time1);
            $(".end").val(time2);
        }else if(format == "yyyyMMddd"){
            var time1 = toDay.getFullYear() + '-' + (toDay.getMonth() + 1) + '-' + toDay.getDate();
            var time2 = toDay.getFullYear() + '-' + (toDay.getMonth() + 1) + '-' + toDay.getDate();
            $(".start").val(time1);
            $(".end").val(time2);
        }else if(format == "yyyyMMddhhsixh"){//提前6个月
            var time1 = dt.getFullYear() + '-' + (dt.getMonth() + 1) + '-' + dt.getDate() + " 00:00";
            var time2 = toDay.getFullYear() + '-' + (toDay.getMonth() + 1) + '-' + toDay.getDate() + " " + toDay.getHours() + ":00";
            $(".start").val(time1);
            $(".end").val(time2);
        }
